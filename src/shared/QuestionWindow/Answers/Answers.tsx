    ...
    if (type === 'multiply') {
        return (
            <div className={styles.Checkbox}>
                <div className={styles.answer}>
                    <input className={styles.hiddenInput} type="checkbox" name="1" id="1" />
                    <label className={styles.checkboxLabel} title='Answer 1' htmlFor='1'>
                        1. answer 1
                    </label>
                </div>
                <div className={styles.answer}>
                    <input className={styles.hiddenInput} type="checkbox" name="2" id="2" />
                    <label className={styles.checkboxLabel} title='Answer 2' htmlFor='2'>
                        2. answer 2
                    </label>
                </div>
                <div className={styles.answer}>
                    <input className={styles.hiddenInput} type="checkbox" name="3" id="3" />
                    <label className={styles.checkboxLabel} title='Answer 3' htmlFor='3'>
                        3. answer 3
                    </label>
                </div>
                <div className={styles.answer}>
                    <input className={styles.hiddenInput} type="checkbox" name="4" id="4" />
        ...
        return (
            <div className={styles.Radio}>
                <div className={styles.answer}>
                    <input className={styles.hiddenInput} type="radio" name="6" id="5" />
                    <label className={`${styles.label} ${styles.trueLabel}`} title='True' htmlFor='5'>
                        True
                    </label>
                </div>
                <div className={styles.answer}>
                    <input className={styles.hiddenInput} type="radio" name="6" id="6" />
