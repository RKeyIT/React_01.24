        ...
        return (
            <div className={styles.Checkbox}>
                <div className={styles.answer}>
                    <input className={styles.hiddenInput} type="checkbox" name="checkbox" id="1" />
                    <label className={styles.checkboxLabel} title='Answer 1' htmlFor='1'>
                        1. answer 1
                    </label>
                </div>
                <div className={styles.answer}>
                    <input className={styles.hiddenInput} type="checkbox" name="checkbox" id="2" />
                    <label className={styles.checkboxLabel} title='Answer 2' htmlFor='2'>
                        2. answer 2
                    </label>
                </div>
                <div className={styles.answer}>
                    <input className={styles.hiddenInput} type="checkbox" name="checkbox" id="3" />
                    <label className={styles.checkboxLabel} title='Answer 3' htmlFor='3'>
                        3. answer 3
                    </label>
                </div>
                <div className={styles.answer}>
                    <input className={styles.hiddenInput} type="checkbox" name="checkbox" id="4" />
